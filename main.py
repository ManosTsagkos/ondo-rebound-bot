Θα δημιουργήσω ένα πλήρες Python script για το macro-adaptive crypto trading bot σύμφωνα με τις οδηγίες σας. Το script θα υλοποιεί τη στρατηγική Macro Swing Trading για το ONDO/USD μέσω Kraken, με δυναμική προσαρμογή παραμέτρων βάσει macro sentiment score.
